from models import VisionTransformer, MutualInformationEstimator
from trainers import DDPIJepaMINETrainer
...
def main(
    ...
    predictor_name="mutual_information_estimator_tiny",
    epochs=300,
    warmup_epochs=40,
    ...
    # Predictor
    #
    predictor = MutualInformationEstimator
    ...
    trainer = DDPIJepaMINETrainer(**trainer_cfg)
