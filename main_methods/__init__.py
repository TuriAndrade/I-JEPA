...
from .ijepa_mine_ddp_train import main as ijepa_mine_ddp_train
from .ijepa_mine_mse_train import main as ijepa_mine_mse_train
from .ijepa_mine_mse_ddp_train import main as ijepa_mine_mse_ddp_train
...
module_dict = {
    ...
    "ijepa_mine_ddp_train": ijepa_mine_ddp_train,
    "ijepa_mine_mse_train": ijepa_mine_mse_train,
    "ijepa_mine_mse_ddp_train": ijepa_mine_mse_ddp_train,
